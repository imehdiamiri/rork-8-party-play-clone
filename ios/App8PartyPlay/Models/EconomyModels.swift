...
nonisolated enum PerformanceBadge: String, CaseIterable, Hashable, Sendable {
    case perfectEcho = "Perfect Echo"
    case reverseMaster = "Reverse Master"
    case closeMatch = "Close Match"
    case funnyTry = "Funny Try"
    case chaosLegend = "Chaos Legend"

    var icon: String {
        switch self {
        case .perfectEcho: return "sparkles"
        case .reverseMaster: return "star.fill"
        case .closeMatch: return "hand.thumbsup.fill"
        case .funnyTry: return "face.smiling.fill"
        case .chaosLegend: return "flame.fill"
        }
    }

    var tint: Color {
        switch self {
        case .perfectEcho: return .yellow
        case .reverseMaster: return .orange
        case .closeMatch: return .green
        case .funnyTry: return .blue
        case .chaosLegend: return .red
        }
    }

    static func badge(for score: Int) -> PerformanceBadge {
        switch score {
        case 95...100: return .perfectEcho
        case 85...94: return .reverseMaster
        case 70...84: return .closeMatch
        case 50...69: return .funnyTry
        default: return .chaosLegend
        }
    }
}
